    ...
    public class PerkPatches
    {
...

        {
            ...
            { // zeal1e: When this hero loses Zeal, deal indirect Holy and Fire damage equal to 4x the number of stacks lost to all monsters.
                ...
                __instance.IndirectDamage(Enums.DamageType.Holy, damageToDeal);
            ...
            if (theEvent == Enums.EventActivation.Killed && __instance.IsHero && __instance != null && CharacterObjectHavePerk(__instance,"zealf") && __instance.HasEffect("zeal"))
            { 
        ...
        public static void HeroLevelUpPrefix(ref AtOManager __instance, Hero[] ___teamAtO, int heroIndex, string traitId)
        {
        ...
        public static void GenerateHeroesPostfix(ref MatchManager __instance, Hero[] ___TeamHero)
        {
            // weak1d: This hero is immune to Weak.";
            
            for (int index = 0; index < 4; ++index){
                Hero _hero =___TeamHero[index];
            ...
            {   
                ...
                // zealf: If this hero dies with Zeal, deal indirect Mind damage to all enemies equal to 5x their Burn/Insane stacks.
                    ...
                    if(_type=="consume"){
                        ...
                        if (TeamHasPerkForConsume("zeal1c",ConsumeAppliesToHeroes,__instance,_characterTarget))
                        {
                            Log.LogDebug(debugBase+"zeal1c");
                            __result.GainCharges = true;
                            __result.CharacterStatModified = Enums.CharacterStat.Speed;
                ...
                // scourge1d: Scourge deals damage based on Burn rather than Chill.";
                // scourge1e: Scourge on monsters increases burn damage by 15%/stack";
                    if (_type=="set")
                    {
                        ...
                        if(TeamHasPerkForSet("scourge1d",AppliesGlobally,__instance,_characterTarget))
                        {
                            ...
                            __result.ConsumedDamageChargesBasedOnACCharges= Globals.Instance.GetAuraCurseData("burn");
                        }
