...
namespace PerkManager
{
    ...
    public class Plugin : BaseUnityPlugin
    {
        ...
        private void Awake()
        {
            ...
            medsTexts[perkStem + "disarm1b"] = "Disarm on this hero cannot be dispelled unless specified, but increases All Resistances by 10%.";
            ...
            medsTexts[perkStem + "energy2e"] = "Energy Regeneration -1. When this hero plays a card that costs 4 or more Energy, refund 1 Energy.";
            medsTexts[perkStem + "energy2f"] = "On every round after round 3, this hero gains 1 additional Energy at the start of the turn.";
            ...
            medsTexts[perkStem + "mitigate1e"] = "Mitigate on heroes and monsters increases All Damage done by 10% per charge.";
            ...
            medsTexts[perkStem + "thorns1f"] = "Rust on heroes increases Thorns damage by 10% per Rust charge.";
            ...
            medsTexts[perkStem + "fortify1e"] = "Fortify on all heroes stacks to 5, but reduces damage done by 1 per charge.";
            medsTexts[perkStem + "fortify1f"] = "At the start of combat, apply 2 Fortify to all heroes. Fortify on all heroes has a maximum of 2.";
            ...
            medsTexts[perkStem + "sharp1g"] = "Sharp on this Hero also increases Mind damage by 1 per charge. Increased to 1.5 per charge with Shrill Tone";
            ...
            medsTexts[perkStem + "spark2g"] = "When this hero applies Spark, the target suffers 2 Crack.";
            ...
            medsTexts[perkStem + "energize1c"] = "Energize increases All Damage by 1 per charge.";
            medsTexts[perkStem + "energize1d"] = "If you end your turn with 4 or more energy, gain 1 Energize.";
            medsTexts[perkStem + "energize1e"] = "This hero is immune to Fatigue.";


            // Custom Text for Spellsword
            medsTexts[perkStem + "spellsword1a"] = "Increases max charges by 2 for all heroes.";
            ...
            medsTexts[perkStem + "powerful1e"] = "Powerful on this hero has no cap, but increases damage done by 2% per charge.";
            ...
            medsTexts[perkStem + "weak1c"] = "Weak cannot be prevented by Immunity or Buffer, but reduces damage and healing by 20% instead of 50%.";
            ...
            medsTexts[perkStem + "insane2d"] = "Crack on monsters increases Blunt damage by an additional 1 for every 50 charges of Insane on that monster.";
            ...
            medsTexts[perkStem + "decay1d"] = "Decay purges Insulate on heroes and monsters.";
            medsTexts[perkStem + "decay1e"] = "Every stack of Decay increases the damage dealt by Poison by 20%.";
            medsTexts[perkStem + "decay1f"] = "Every stack of Decay increases the damage dealt by Bleed by 20%.";
            medsTexts[perkStem + "decay1g"] = "When you apply Decay, apply and suffer 1 Rust (untested).";
